...
class _$LoginStateTearOff {
  ...
  _LoginState call(
      {@EmailConverter() Email email = const Email.pure(),
      @PasswordConverter() Password password = const Password.pure(),
...
class _$_LoginState implements _LoginState {
  const _$_LoginState(
      {@EmailConverter() this.email = const Email.pure(),
      @PasswordConverter() this.password = const Password.pure(),
